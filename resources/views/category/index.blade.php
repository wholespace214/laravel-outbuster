                                        ...
                                        <div class="details">
                                            ...
                                            <div class="production-text">
                                                <ul class="production-details">
                                                    <li>Film<span class="dash">-</span>Classification :
                                                        <strong>PG13</strong>
                                                    </li>
                                ...
                                <div class="category-pop category-maximize">
                                    ...
                                    <div class="banner-wrap">
                                        ...
                                        <div class="details">
                                            ...
                                            <p>Ai n'a pas vraiment eu de chance dans la loterie de la vie. Rejetée par sa
                                                mère,
                                                elle grandit pendant 7 ans dans une secte fanatique religieuse, avant que le
                                                gourou ne se fasse embarquer par la police. Livrée à elle-même elle enchaîne
                                                différents milieux et l'apprentissage des codes sociaux dans l'espoir de se
                                                trouver une place.<br>Toutes fréquentations est bonne à prendre, même les
                                                plus
                                                sombres. Pourvu qu'on y trouve un peu d'amour.</p>
                                            <div class="production-text">
                                                <ul class="production-details">
                                                    <li>Film<strong> Japonais</strong></li>
                                                    <li>Catégorie:<strong> Complètement à l'est</strong></li>
                                                    <li>Genre:<strong> Drame initiatique</strong></li>
                                                    <li>Realise:<strong> Eiji Uchida</strong></li>
                                                    <li>Avac:<strong> Sairi Ito, Kaito Yoshimua, Kenta Suga</strong></li>
                                                    <li>Durée:<strong> 1h35</strong></li>
                                            ...
                                            <div class="critic-container">
                                                ...
                                                <div class="critic">
                                                    <p>
                                                        ...
                                                        dolor,
                                                        cursus sit amet dictum id, laoreet quis erat. Vivamus ut massa
                                                        magna.
                                                        Integer fringilla sit amet massa molestie pellentesque. Curabitur
                                                        non
                                                        lorem id est molestie sollicitudin ut quis lorem. Nunc lacinia
                                                        ligula id
                                                        lorem semper, a congue tortor tempor...
                                                    </p>
                                                </div>
